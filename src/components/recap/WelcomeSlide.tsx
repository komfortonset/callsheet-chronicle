  ...
  return (
    <RecapSlide variant="dark">
      <div className="text-center space-y-8 animate-fade-in">
        ...
        <h1 className="text-6xl font-black text-white animate-slide-up" style={{ animationDelay: "400ms" }}>
          Your 2025
          <br />
          Calltime Wrapped
        </h1>
        <p className="text-2xl text-white/80 max-w-md mx-auto animate-fade-in" style={{ animationDelay: "600ms" }}>
